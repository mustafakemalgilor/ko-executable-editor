...
namespace KOExecutableEditor
{
    public class PeHeaderReader
    {
        ...
        public enum DataSectionFlags : uint
        {
            ...
            /// <summary>
            ///     The section contains comments or other information. The .drectve section has this type. This is valid for object
            ///     files only.
            /// </summary>
            LinkInfo = 0x00000200,
            ...
            /// <summary>
            ///     The section contains COMDAT data. For more information, see section 5.5.6, COMDAT Sections (Object Only). This is
        ...
        public static PeHeaderReader GetAssemblyHeader()
        {
            // Get the path to the calling assembly, which is the path to the
            // DLL or EXE that we want the time of
            var filePath = Assembly.GetAssembly(typeof (PeHeaderReader)).Location;
